...
public class CashbookController {
	...
	public String cashbookByMonth(Model model, 
		...
		// 실제로 포워딩 되는 것은 prefix에서 지정한 /WEB-INF/view/cashbookByMonth.jsp으로 반환됨
	...
	// cashbookByDay 삭제
	@GetMapping("/admin/removeCashbookByDay/{cashbookId}")
	...
	public String cashbookList(Model model, @PathVariable(name = "currentPage", required = true) int currentPage) {
		...
		int totalCount = cashbookService.getCountCashbook();	// 전체 데이터 수
